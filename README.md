...
- **DCSA Library Rebuilder** (`adamsdarin/dcsa-library-rebuilder`) — holds records retained by their bytes only; this project's byte-verified provenance is how those records can gain official URLs.
